...
class HelpPage extends StatelessWidget {
  ...
  List<Widget> _helps(BuildContext context) {
    ...
    return [
          ...
          children: [
            _SubSection(
              ...
              bullets: [
                  ...
                  TextSpan(
                    ...
                    children: [
                      ...
                      WidgetSpan(
                        ...
                        child: Icon(dictWordSelectModalOpenIcon, size: 20),
                      ),
                      const TextSpan(
                        text: ' icon to open the lexicon and word selector.',
                      ),
                    ],
                  ),
                ),
                ...
                Bullet('The last inserted word is automatically selected'),
              ],
            ),
            ...
            Theme(
              ...
              child: const ExpansionTile(
                title: _SubTilte('Details (tap a name for details)'),
          ...
          children: [
            _SubSection(
              ...
              bullets: [
                ...
                Bullet('While reading, tap any word to see its meaning.'),
                Bullet(
                  'Looked-up words are highlighted in blue, if enabled, and saved in Foreign Words for easier review.',
                ),
                Bullet('Settings are saved separately for each book entry.'),
                Bullet(
      ...
      _Section(title: 'Keyboard Shortcuts', child: const ShortcutsHelpList()),
  ...
  Widget build(BuildContext context) {
    const spaceBetweenSections = SizedBox(height: 14);
            ...
            SliverPadding(
              ...
              sliver: SliverList.list(
                children: separatedList(
                  separatorBuilder: (_) => spaceBetweenSections,
                  list: _helps(context),
                ),
              ),
            ),
